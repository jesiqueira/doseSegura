  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <h1 className={styles.titulo}>Vivendo Bem: Dicas Práticas para uma Vida Saudável</h1>
        <div className={styles.info_saude}>
          <img className={styles.img} src={estetoscopio} alt="foto estetoscópio " />
          <div className={styles.paragrafo}>
            ...
            <p>
              Além de monitorar o estado geral da saúde, essas consultas estabelecem uma relação contínua com profissionais de saúde, possibilitando
              uma abordagem personalizada e a promoção de hábitos de vida saudáveis.
            </p>
            <p>
        ...
        <div className={styles.info_fruta}>
          <div className={styles.paragrafo}>
            <p>
              ...
              uma dieta equilibrada, o consumo regular de frutas desempenha um papel vital, oferecendo vitaminas, minerais e antioxidantes que
            ...
            <p>
              A combinação de uma alimentação nutritiva com exercícios físicos fortalece não apenas o corpo, mas também melhora a saúde
              cardiovascular, reduz o estresse e promove uma sensação geral de equilíbrio e vitalidade. Portanto, incorporar tanto frutas quanto
              atividade física diariamente estabelece as bases essenciais para uma vida equilibrada e vibrante.
            </p>
          </div>
          <img className={styles.img} src={fruta} alt="Cesto com frutas " />
        </div>
      </main>
    </>
  )
